    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_birth.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(Kalendar.this, android.R.style.Theme_Holo_Light_Dialog_MinWidth, dateSetListener1, year, month, day
                );
        ...
        btn_today.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // date picker dialog is used
                // and its style and color are also passed
                DatePickerDialog datePickerDialog = new DatePickerDialog(Kalendar.this, android.R.style.Theme_Holo_Light_Dialog_MinWidth, dateSetListener2, year, month, day
                );
                // to set background for datepicker
                datePickerDialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
                datePickerDialog.show();
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    if (startdate <= endDate) {
                        ...
                        // show message
                        Toast.makeText(Kalendar.this, "BirthDate should not be larger then today's date!", Toast.LENGTH_SHORT).show();
                    }
